...
const MatrixVisualization = ({ initialState, rounds, currentRound, setCurrentRound }) => {
  ...
  const allStates = [
    { label: 'Initial State', matrix: initialState, operation: 'Initial' },
    ...rounds.map(round => ({
  ...
  const Matrix = ({ matrix, title, operation }) => (
    ...
    >
      <div className="text-center mb-4">
        ...
        <p className="text-sm text-blue-300">{operation}</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass rounded-lg p-4 border border-white/20">
        <h4 className="text-white font-semibold mb-3">Round Timeline</h4>
