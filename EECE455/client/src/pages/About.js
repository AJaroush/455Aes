...
import { Shield, Code, Users, Heart, Github, ExternalLink, Award, Zap, User } from 'lucide-react';
...
const About = () => {
  ...
  const stats = [
    ...
    { label: 'Lines of Code', value: '2000+', icon: Github }
  ];
    ...
    <div className="pt-16 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="glass rounded-2xl p-8 border border-white/20 mb-16"
        >
          ...
          <div className="flex flex-nowrap justify-center gap-6 overflow-x-auto">
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div className="text-lg font-bold text-white mb-2">{member.name}</div>
            ...
            {stats.map((stat, index) => {
              ...
              return (
                <motion.div
                  ...
                  transition={{ delay: index * 0.1, duration: 0.5 }}
                  viewport={{ once: true }}
                  className="text-center p-6 glass rounded-xl border border-white/20"
                >
                  <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg mb-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {technologies.map((tech, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.1, duration: 0.5 }}
                viewport={{ once: true }}
                className="text-center p-4 glass rounded-lg border border-white/20 hover:border-white/40 transition-all duration-300"
              >
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center space-x-2 px-6 py-3 glass text-white rounded-lg hover:bg-white/20 transition-all duration-300 border border-white/20"
              >
